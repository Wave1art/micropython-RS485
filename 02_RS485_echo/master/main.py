# Master - load this to the ESP32 device acting as master
...
# Run the core example as Master device

# Short sleep to allow time for everything to settle down before starting tx/rx cycle
time.sleep_ms(500)

print('Starting test - Send + Receive...')
iterations = 10

for i in range(iterations):

    send_message(f'This is message number {i} sent.')
